...
function create_post_type_martoyas_slider(){
	register_post_type( 'martoyas_slider', [
		...
		'show_ui'               => true,
		'show_in_menu'          => false, // не  отображать post type в меню вордпресс (нужо для того чтобы сделать его отображение в под мнею у плагина)
...
add_action( 'init', 'create_post_type_martoyas_slider' );
